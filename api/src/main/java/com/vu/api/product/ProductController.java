...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<ProductResponse>> create(
            @Valid @RequestBody ProductCreateRequest req, HttpServletRequest httpReq) {
    ...
    public ResponseEntity<ApiResponse<ProductResponse>> update(
            @PathVariable Long id, @Valid @RequestBody ProductUpdateRequest req, HttpServletRequest httpReq) {
