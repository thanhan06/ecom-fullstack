...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<UserResponse>> create(
            @Valid @RequestBody UserCreateRequest req, HttpServletRequest httpReq) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<UserResponse>> getById(@PathVariable Long id, HttpServletRequest httpReq) {
    ...
    public ResponseEntity<ApiResponse<UserResponse>> assignRole(
            @PathVariable Long id, @Valid @RequestBody AssignRoleRequest req, HttpServletRequest httpReq) {
