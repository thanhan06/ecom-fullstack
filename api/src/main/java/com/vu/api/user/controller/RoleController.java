...
public class RoleController {
    ...
    public ResponseEntity<ApiResponse<RoleResponse>> create(
            @Valid @RequestBody RoleCreateRequest request, HttpServletRequest req) {
    ...
    public ResponseEntity<ApiResponse<Void>> assignPermissions(
            @PathVariable Long roleId, @Valid @RequestBody AssignPermissionRequest request, HttpServletRequest req) {
